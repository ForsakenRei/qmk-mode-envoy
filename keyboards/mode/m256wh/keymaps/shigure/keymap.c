...
[1] = LAYOUT(
    ...
    _______, _______, _______, KC_CALC, _______, _______, _______, SERACH,  TSK_MGR, _______, _______, _______,          _______, _______,
    _______, _______, _______,                            KC_DEL,                    _______, CTL_APP,          _______, _______, _______
),
[2] = LAYOUT(
    _______, _______, _______, _______, _______, _______, _______, KC_P7,   KC_P8,   KC_P9,   KC_P0,   KC_PMNS, KC_PPLS, SFT_DEL, KC_SLEP,
    ...
    _______, _______, _______, KC_CALC, _______, _______, _______, KC_P0,   KC_P0,   KC_PDOT, _______, _______,          _______, KC_MUTE,
    _______, GUI_TOG, _______,                            KC_DEL,                    _______, _______,          _______, _______, _______
),
[3] = LAYOUT(
    RBG_TOG, _______, _______, _______, _______, KC_VOLD, KC_VOLU, KC_MPLY, KC_MUTE, _______, _______, KC_F13,  KC_F14,  _______, RGB_SAI,
