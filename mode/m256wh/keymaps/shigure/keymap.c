...
[3] = LAYOUT_65_ansi_blocker(
    UG_TOGG, KC_MUTE, KC_VOLD, KC_VOLU, KC_MPRV, KC_MPLY, KC_MNXT, _______, _______, _______, _______, KC_F13,  KC_F14,  _______, UG_SATU,
    ...
    _______, _______, _______, _______, _______, _______, _______, DC_MUTE, _______, _______, _______, QK_RBT,           UG_PREV, UG_HUED,
    _______, _______, _______,                            _______,                   TO(0),   _______,          UG_VALD, UG_NEXT, UG_VALU
)
};
